<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginMessage.aspx.cs" Inherits="Default2" %>
    ...
    <div>
        ...
        <asp:Menu ID="Menu1" runat="server" Font-Bold="False" Font-Italic="False" Font-Names="楷体" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="True" ForeColor="#3366CC">
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/LoginFileupload .aspx" Text="上傳作品" Value="3"></asp:MenuItem>
