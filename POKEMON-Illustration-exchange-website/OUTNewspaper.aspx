<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OUTNewspaper.aspx.cs" Inherits="_Default" %>
    ...
    <div>
        ...
        <asp:Menu ID="Menu1" runat="server" OnMenuItemClick="Menu1_MenuItemClick" Font-Names="楷体" Font-Size="XX-Large" Font-Underline="True" ForeColor="#3366CC">
            <Items>
                ...
                <asp:MenuItem Text="註冊" Value="3" NavigateUrl="~/OUTNews.aspx"></asp:MenuItem>
